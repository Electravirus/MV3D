...
@param dynShadowDist
@text Dynamic Shadow Render Distance
@parent shadow
@type Number
@default 20

@param dynShadowRes
@text Dynamic Shadow Resolution
@parent shadow
@type Number
@default 1024

@param dynShadowFalloff
@text Dynamic Shadow Falloff
@parent shadow
@desc How smoothly the shadow fades at the edge of render distance.
@type Number
@decimals 2
@default 0.5
